...
static DEVICE_ATTR(tw_knockon, S_IRUGO | S_IWUGO, touchwake_knockon_read, touchwake_knockon_write);
static DEVICE_ATTR(tw_delay, S_IRUGO | S_IWUGO, touchwake_delay_read, touchwake_delay_write);
static DEVICE_ATTR(tw_charging_delay, S_IRUGO | S_IWUGO, touchwake_charging_delay_read, touchwake_charging_delay_write);
static DEVICE_ATTR(tw_keypower_mode, S_IRUGO | S_IWUGO, touchwake_keypower_read, touchwake_keypower_write);
...
static struct attribute *touchwake_notification_attributes[] =
{
	...
	&dev_attr_tw_knockon.attr,
	&dev_attr_tw_delay.attr,
	&dev_attr_tw_keypower_mode.attr,
	&dev_attr_tw_charging_delay.attr,
